...
/**
 * This is the item provider adapter for a {@link org.muml.eloquent.example.drwahnsinn.Tile} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TileItemProvider 
	...
	public String getText(Object object) {
		TileType labelValue = ((Tile)object).getType();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_Tile_type") :
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Tile.class)) {
			case DrwahnsinnPackage.TILE__TYPE:
