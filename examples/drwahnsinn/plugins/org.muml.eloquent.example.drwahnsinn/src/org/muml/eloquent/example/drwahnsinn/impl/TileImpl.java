 ...
 * </p>
 * <ul>
 *   <li>{@link org.muml.eloquent.example.drwahnsinn.impl.TileImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TileImpl extends MinimalEObjectImpl.Container implements Tile {
	 ...
	 * @ordered
	 */
	protected static final TileType TYPE_EDEFAULT = TileType.TYPE_3X2X2;
	...
	protected EClass eStaticClass() {
		return DrwahnsinnPackage.Literals.TILE;
	}
	...
	public void setType(TileType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrwahnsinnPackage.TILE__TYPE, oldType, type));
	}
