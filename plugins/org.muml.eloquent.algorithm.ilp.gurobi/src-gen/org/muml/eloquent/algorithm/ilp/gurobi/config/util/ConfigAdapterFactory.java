...
public class ConfigAdapterFactory extends AdapterFactoryImpl {
	...
	protected ConfigSwitch<Adapter> modelSwitch =
		new ConfigSwitch<Adapter>() {
			@Override
			public Adapter caseGurobiExportConfiguration(GurobiExportConfiguration object) {
				return createGurobiExportConfigurationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.muml.eloquent.algorithm.ilp.gurobi.config.GurobiExportConfiguration <em>Gurobi Export Configuration</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGurobiExportConfigurationAdapter() {
		return null;
	}
