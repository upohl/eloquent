		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTupleDescriptorAccess().getAlternatives_1(), "rule__TupleDescriptor__Alternatives_1");
					put(grammarAccess.getWeightTupleDescriptorAccess().getAlternatives_4(), "rule__WeightTupleDescriptor__Alternatives_4");
					put(grammarAccess.getBoundWeightTupleDescriptorAccess().getAlternatives_7(), "rule__BoundWeightTupleDescriptor__Alternatives_7");
					...
					put(grammarAccess.getTupleDescriptorAccess().getGroup_1_1(), "rule__TupleDescriptor__Group_1_1__0");
					put(grammarAccess.getTupleDescriptorAccess().getGroup_1_1_1(), "rule__TupleDescriptor__Group_1_1_1__0");
					put(grammarAccess.getWeightTupleDescriptorAccess().getGroup(), "rule__WeightTupleDescriptor__Group__0");
					put(grammarAccess.getWeightTupleDescriptorAccess().getGroup_4_1(), "rule__WeightTupleDescriptor__Group_4_1__0");
					put(grammarAccess.getWeightTupleDescriptorAccess().getGroup_4_1_1(), "rule__WeightTupleDescriptor__Group_4_1_1__0");
					put(grammarAccess.getBoundWeightTupleDescriptorAccess().getGroup(), "rule__BoundWeightTupleDescriptor__Group__0");
					put(grammarAccess.getBoundWeightTupleDescriptorAccess().getGroup_7_1(), "rule__BoundWeightTupleDescriptor__Group_7_1__0");
					put(grammarAccess.getBoundWeightTupleDescriptorAccess().getGroup_7_1_1(), "rule__BoundWeightTupleDescriptor__Group_7_1_1__0");
					...
					put(grammarAccess.getForbiddenLocationConstraintAccess().getGroup(), "rule__ForbiddenLocationConstraint__Group__0");
					...
					put(grammarAccess.getTupleDescriptorAccess().getSequencePartAssignment_1_0(), "rule__TupleDescriptor__SequencePartAssignment_1_0");
					put(grammarAccess.getTupleDescriptorAccess().getTypedPairsAssignment_1_1_0(), "rule__TupleDescriptor__TypedPairsAssignment_1_1_0");
					put(grammarAccess.getTupleDescriptorAccess().getTypedPairsAssignment_1_1_1_1(), "rule__TupleDescriptor__TypedPairsAssignment_1_1_1_1");
					put(grammarAccess.getWeightTupleDescriptorAccess().getWeightAssignment_1(), "rule__WeightTupleDescriptor__WeightAssignment_1");
					put(grammarAccess.getWeightTupleDescriptorAccess().getSequencePartAssignment_4_0(), "rule__WeightTupleDescriptor__SequencePartAssignment_4_0");
					put(grammarAccess.getWeightTupleDescriptorAccess().getTypedPairsAssignment_4_1_0(), "rule__WeightTupleDescriptor__TypedPairsAssignment_4_1_0");
					put(grammarAccess.getWeightTupleDescriptorAccess().getTypedPairsAssignment_4_1_1_1(), "rule__WeightTupleDescriptor__TypedPairsAssignment_4_1_1_1");
					...
					put(grammarAccess.getBoundWeightTupleDescriptorAccess().getSequencePartAssignment_7_0(), "rule__BoundWeightTupleDescriptor__SequencePartAssignment_7_0");
					put(grammarAccess.getBoundWeightTupleDescriptorAccess().getTypedPairsAssignment_7_1_0(), "rule__BoundWeightTupleDescriptor__TypedPairsAssignment_7_1_0");
					put(grammarAccess.getBoundWeightTupleDescriptorAccess().getTypedPairsAssignment_7_1_1_1(), "rule__BoundWeightTupleDescriptor__TypedPairsAssignment_7_1_1_1");
					...
					put(grammarAccess.getForbiddenLocationConstraintAccess().getNameAssignment_1(), "rule__ForbiddenLocationConstraint__NameAssignment_1");
					put(grammarAccess.getForbiddenLocationConstraintAccess().getTupleDescriptorAssignment_3(), "rule__ForbiddenLocationConstraint__TupleDescriptorAssignment_3");
					put(grammarAccess.getForbiddenLocationConstraintAccess().getExpressionAssignment_5(), "rule__ForbiddenLocationConstraint__ExpressionAssignment_5");
