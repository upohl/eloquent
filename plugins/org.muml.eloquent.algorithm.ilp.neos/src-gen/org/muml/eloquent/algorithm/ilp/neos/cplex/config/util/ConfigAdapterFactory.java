/**
 */
package org.muml.eloquent.algorithm.ilp.neos.cplex.config.util;
...
public class ConfigAdapterFactory extends AdapterFactoryImpl {
	...
	protected ConfigSwitch<Adapter> modelSwitch =
		new ConfigSwitch<Adapter>() {
			@Override
			public Adapter caseCPLEXConfiguration(CPLEXConfiguration object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.muml.eloquent.algorithm.ilp.neos.cplex.config.CPLEXConfiguration <em>CPLEX Configuration</em>}'.
	 * <!-- begin-user-doc -->
