...
public abstract class AbstractAllocationSpecificationSyntacticSequencer extends AbstractSyntacticSequencer {

	protected AllocationSpecificationGrammarAccess grammarAccess;
	protected AbstractElementAlias match_TupleTypeCS___LeftParenthesisKeyword_1_0_RightParenthesisKeyword_1_2__q;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (AllocationSpecificationGrammarAccess) access;
