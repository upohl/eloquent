...
@Singleton
public class AllocationSpecificationGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class SpecificationElements extends AbstractParserRuleElementFinder {
		...
		//	{specification::Specification} name=ID "{" (services+=Service | constraints+=Constraint)* measure=MeasureFunction "}";
	...
	public class QosDimensionElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cMetricIDParserRuleCall_11_0 = (RuleCall)cMetricAssignment_11.eContents().get(0);
		...
		//ID
		public RuleCall getMetricIDParserRuleCall_11_0() { return cMetricIDParserRuleCall_11_0; }
	...
	public class ResourceConstraintElements extends AbstractParserRuleElementFinder {
		...
		//	tupleDescriptors+=ComponentResourceTupleDescriptor ("," tupleDescriptors+=ComponentResourceTupleDescriptor)* ";" //'ocl' expression=STRING';'
		//	"}";
		public ParserRule getRule() { return rule; }
	...
	public class RequiredHardwareResourceInstanceConstraintElements extends AbstractParserRuleElementFinder {
		...
		//	tupleDescriptors+=ComponentResourceTupleDescriptor)* ";" //'ocl' expression=STRING';'
		//	"}";
		public ParserRule getRule() { return rule; }
	...
	public class MeasureFunctionElements extends AbstractParserRuleElementFinder {
		...
		private final CrossReference cServicesServiceCrossReference_1_0 = (CrossReference)cServicesAssignment_1.eContents().get(0);
		private final RuleCall cServicesServiceIDParserRuleCall_1_0_1 = (RuleCall)cServicesServiceCrossReference_1_0.eContents().get(1);
		...
		private final CrossReference cServicesServiceCrossReference_2_1_0 = (CrossReference)cServicesAssignment_2_1.eContents().get(0);
		private final RuleCall cServicesServiceIDParserRuleCall_2_1_0_1 = (RuleCall)cServicesServiceCrossReference_2_1_0.eContents().get(1);
		...
		//services+=[specification::Service]
		public Assignment getServicesAssignment_1() { return cServicesAssignment_1; }

		//[specification::Service]
		public CrossReference getServicesServiceCrossReference_1_0() { return cServicesServiceCrossReference_1_0; }

		//ID
		public RuleCall getServicesServiceIDParserRuleCall_1_0_1() { return cServicesServiceIDParserRuleCall_1_0_1; }
		...
		//[specification::Service]
		public CrossReference getServicesServiceCrossReference_2_1_0() { return cServicesServiceCrossReference_2_1_0; }

		//ID
		public RuleCall getServicesServiceIDParserRuleCall_2_1_0_1() { return cServicesServiceIDParserRuleCall_2_1_0_1; }
	...
	@Inject
	public AllocationSpecificationGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("de.uni_paderborn.fujaba.muml.allocation.language.AllocationSpecification".equals(grammar.getName())) {
				return grammar;
			}
