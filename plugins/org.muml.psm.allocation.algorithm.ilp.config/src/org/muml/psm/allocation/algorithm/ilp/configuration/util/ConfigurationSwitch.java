/**
 */
package org.muml.psm.allocation.algorithm.ilp.configuration.util;
...
public class ConfigurationSwitch<T1> extends Switch<T1> {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ConfigurationPackage.ILP_EXPORT_CONFIGURATION: {
				ILPExportConfiguration<?> ilpExportConfiguration = (ILPExportConfiguration<?>)theEObject;
				T1 result = caseILPExportConfiguration(ilpExportConfiguration);
