 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.allocation.language.impl.ComponentResourceTupleDescriptorImpl#getHwresinstance <em>Hwresinstance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ComponentResourceTupleDescriptorImpl extends InstanceTupleDescriptorImpl implements ComponentResourceTupleDescriptor {
	...
	protected EClass eStaticClass() {
		return LanguagePackage.Literals.COMPONENT_RESOURCE_TUPLE_DESCRIPTOR;
	}
	...
	public void setHwresinstance(String newHwresinstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.COMPONENT_RESOURCE_TUPLE_DESCRIPTOR__HWRESINSTANCE, oldHwresinstance, hwresinstance));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LanguagePackage.COMPONENT_RESOURCE_TUPLE_DESCRIPTOR__HWRESINSTANCE:
