 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.allocation.language.impl.RequiredHardwareResourceInstanceConstraintImpl#getTupleDescriptors <em>Tuple Descriptors</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RequiredHardwareResourceInstanceConstraintImpl extends ConstraintImpl implements RequiredHardwareResourceInstanceConstraint {
	...
	protected EClass eStaticClass() {
		return LanguagePackage.Literals.REQUIRED_HARDWARE_RESOURCE_INSTANCE_CONSTRAINT;
	}
	...
	public EList<ComponentResourceTupleDescriptor> getTupleDescriptors() {
		if (tupleDescriptors == null) {
			tupleDescriptors = new EObjectContainmentEList<ComponentResourceTupleDescriptor>(ComponentResourceTupleDescriptor.class, this, LanguagePackage.REQUIRED_HARDWARE_RESOURCE_INSTANCE_CONSTRAINT__TUPLE_DESCRIPTORS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LanguagePackage.REQUIRED_HARDWARE_RESOURCE_INSTANCE_CONSTRAINT__TUPLE_DESCRIPTORS:
