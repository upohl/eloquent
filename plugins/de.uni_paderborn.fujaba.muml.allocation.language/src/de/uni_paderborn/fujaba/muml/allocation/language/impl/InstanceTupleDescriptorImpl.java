 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.allocation.language.impl.InstanceTupleDescriptorImpl#getInstance <em>Instance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class InstanceTupleDescriptorImpl extends TupleDescriptorImpl implements InstanceTupleDescriptor {
	...
	protected EClass eStaticClass() {
		return LanguagePackage.Literals.INSTANCE_TUPLE_DESCRIPTOR;
	}
	...
	public void setInstance(String newInstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.INSTANCE_TUPLE_DESCRIPTOR__INSTANCE, oldInstance, instance));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LanguagePackage.INSTANCE_TUPLE_DESCRIPTOR__INSTANCE:
				return getInstance();
		}
