 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.allocation.language.impl.LocationTupleDescriptorImpl#getInstances <em>Instances</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LocationTupleDescriptorImpl extends InstanceTupleDescriptorImpl implements LocationTupleDescriptor {
	...
	protected EClass eStaticClass() {
		return LanguagePackage.Literals.LOCATION_TUPLE_DESCRIPTOR;
	}
	...
	public void setInstances(String newInstances) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.LOCATION_TUPLE_DESCRIPTOR__INSTANCES, oldInstances, instances));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LanguagePackage.LOCATION_TUPLE_DESCRIPTOR__INSTANCES:
				return getInstances();
		}
