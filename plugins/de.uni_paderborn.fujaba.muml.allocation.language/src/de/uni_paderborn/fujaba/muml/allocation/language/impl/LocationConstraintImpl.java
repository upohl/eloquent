 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.allocation.language.impl.LocationConstraintImpl#getTupleDescriptors <em>Tuple Descriptors</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.allocation.language.impl.LocationConstraintImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LocationConstraintImpl extends ConstraintImpl implements LocationConstraint {
	...
	protected EClass eStaticClass() {
		return LanguagePackage.Literals.LOCATION_CONSTRAINT;
	}
	...
	public EList<LocationTupleDescriptor> getTupleDescriptors() {
		if (tupleDescriptors == null) {
			tupleDescriptors = new EObjectContainmentEList<LocationTupleDescriptor>(LocationTupleDescriptor.class, this, LanguagePackage.LOCATION_CONSTRAINT__TUPLE_DESCRIPTORS);
		}
	...
	public void setType(LocationConstraintTypes newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.LOCATION_CONSTRAINT__TYPE, oldType, type));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LanguagePackage.LOCATION_CONSTRAINT__TUPLE_DESCRIPTORS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case LanguagePackage.LOCATION_CONSTRAINT__TYPE:
				return getType();
		}
